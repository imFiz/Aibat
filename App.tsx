  ...
  return (
    <div className="flex justify-center min-h-screen bg-black">
      <div className="w-full max-w-[450px] h-[100dvh] bg-[#121212] flex flex-col relative shadow-2xl border-x border-[#1E1E1E]">
        ...
        {/* TOAST */}
        {toast && (
            <div className={`absolute top-20 left-1/2 transform -translate-x-1/2 w-[90%] px-4 py-3 rounded-xl shadow-2xl z-[60] flex items-center space-x-3 transition-all animate-fade-in ${
                toast.type === 'error' 
